...
from utils.util import kakao_send

class BaseTrainer:
    def __init__(self, model, loss_fn, metric_ftns, optimizer, config, data_loader):
        self.config = config
        self.model = model
    ...
    def train(self):
        ...
        for epoch in range(self.start_epoch, self.epochs + 1):
            ...
            kakao_send(str(result))

            # save logged informations into log dict
            log = {'epoch': epoch}
            log.update(result)

            # print logged informations to the console screen
    ...
    def _save_checkpoint(self, epoch, save_best=False):
        ...
        state = {
            ...
            #  'swa_mode_state_dict': self.swa_model.state_dict(),
